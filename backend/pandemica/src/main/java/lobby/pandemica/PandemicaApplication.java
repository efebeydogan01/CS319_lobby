...
public class PandemicaApplication {
	...
	CommandLineRunner run(UserService userService) {
		return args -> {
			userService.create(new UserDto(UUID.randomUUID(),"elif beydogan", "passoword",
					21212122, new Date(System.currentTimeMillis()), "53112312123"));
			userService.create(new UserDto(UUID.randomUUID(),"efe beydogan", "passoword",
					29992122, new Date(System.currentTimeMillis()), "53112312123"));
			userService.create(new UserDto(UUID.randomUUID(),"cagtay beydogan", "passoword",
					21000022, new Date(System.currentTimeMillis()), "53112312123"));
			userService.create(new UserDto(UUID.randomUUID(),"mama polat", "passoword",
